...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val defaultImageAnimals = listOf(
        ...
        val defaultNameAnimals = listOf("Koi Carp", "Spiny Dogfish", "Kaluga")
        val defaultListDescription = listOf(
            //Koi Carp
        ...
        imageAnimals = intent.extras?.getStringArrayList("imageAnimals") ?: defaultImageAnimals
        nameAnimals = intent.extras?.getStringArrayList("nameAnimals") ?: defaultNameAnimals
        descriptionAnimals =
            intent.extras?.getStringArrayList("descriptionAnimals") ?: defaultListDescription
        ...
        val pagerAdapter = MyPagerAdapter(contentUpdater)
